...
- **Selector deployment reported, live-client acceptance pending (2026-09-08):** Support result `7d4731d6-8598-4974-b058-ed15a8894dbb` reports `assign_exact_task_profile_kandev` deployed from `29fbaca7dd5035d7ed1ed4a01edb731097fceb34`, with 122/122 deployment checks. The existing Coordinator client still has no callable entry after a new ordinary turn. Keep this distinct from a verified usable selector: discover its actual schema and run assignment/readback plus idempotence checks before lifting holds. Do not resume a mismatched runtime to test availability. See the runbook acceptance procedure.
