...
- **Authority** Human cost-control directive 2026-09-06, Coordinator Sol-or-Astra clarification 2026-09-08, and host-specific Review clarification 2026-09-09; see [Audit and contain Codex lane-model mismatches](RUNBOOK.md#audit-and-contain-codex-lane-model-mismatches).
...
- **Never** Infer the host/client from a model string or profile name, impose the Codex `gpt-5.5` Review rule on a Copilot-hosted reviewer, wake a truly mismatched parked session to ask it to switch, substitute a cheaper or heavier Codex model for the configured Codex lane, or count terminal history as current usage.
