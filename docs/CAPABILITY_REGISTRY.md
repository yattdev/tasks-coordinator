...
- **Partial recovery observed 2026-09-15:** the successor became the sole primary without a caller-visible promotion transaction, while queue census still returned `UNKNOWN_ACTION`. A routine wake subsequently reached the old non-primary session. Primary readback proves the current role owner, not queue parity, routine targeting, or fencing; preserve the predecessor and keep those criteria open.
