...
- [docs/TASK_MONITORING_CHECKLIST.md](docs/TASK_MONITORING_CHECKLIST.md) — exhaustive per-touch, lane-by-lane, PR/CI, exception, and reporting checklist
